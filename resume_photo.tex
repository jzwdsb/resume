...
\Large{
  \begin{tabu}{ clr }
   \multirow{5}{1in}{\includegraphics[width=0.88in, height=1.15in]{avatar}} & \scshape{贾臻玮} & \pbar{C++}{0.75} \\
    & \email{manout960920@outlook.com} & \pbar{Java}{0.5} \\
    & \phone{(+86) 151-000-38767} & \pbar{Linux}{0.4} \\
    & \github[github.com/jzwdsb]{https://github.com/jzwdsb} & \pbar{Python}{0.6} \\
...
\datedsubsection{\textbf{试验机管理平台}}{2017年12月 -- 2018年02月}
负责后端开发
\begin{itemize}
  \item 使用了 JFinal 框架
\end{itemize}
